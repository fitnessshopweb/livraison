...
function afficherLivraison ($livraison){
	...
	function ajouterLivraison($livraison){
		$sql="insert into livraison (region,methodeL,adresseL,dateL,numeroC,etat,user_id) values( :region,:methode,:adresse,:dateLivraison,:numeroCommande,:etat,:user_id)";
		$sql2="UPDATE livraison SET id_livreur=(select id from livreurl WHERE etat='active' AND nombreL<10 ORDER BY RAND() limit 1) ORDER BY id DESC limit 1";
