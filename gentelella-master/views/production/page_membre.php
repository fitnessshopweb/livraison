...
if (isset($_SESSION['l']) && isset($_SESSION['p']) && isset($_SESSION['i'])) 
{ 

	 echo 'Votre login est <b>'.$_SESSION['l'].'</b> <br>et votre mot de passe est <b>'.$_SESSION['p'].
	'</b><br>Votre role est : '.$_SESSION['r'].' <br/> <br>Votre role est : '.$_SESSION['i'].' <br/> Identifiant de la session est :'.session_id().'</br>'; 
